...
def test_structure_learning():
    X = numpy.random.randint(2, size=(10, 4))
    model = BayesianNetwork.from_samples(X, algorithm='exact')
    assert_equal(model.structure, ((), (), (0,), ()))


def test_structure_learning_exact():
    X = numpy.random.randint(2, size=(100, 10))
    model = BayesianNetwork.from_samples(X, algorithm='exact')
    model2 = BayesianNetwork.from_samples(X, algorithm='exact-shortest')

    assert_equal(model.structure, model2.structure)
    assert_equal(model.structure, ((), (), (), (0,), (), (), (), (), (0,), ()))


def test_parallel_structure_learning():
    X = numpy.random.randint(2, size=(10, 5))
    model = BayesianNetwork.from_samples(X, algorithm='exact')
